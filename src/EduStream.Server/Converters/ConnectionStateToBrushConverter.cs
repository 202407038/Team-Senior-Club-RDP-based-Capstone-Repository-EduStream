...
public sealed class ConnectionStateToBrushConverter : IValueConverter
{
    ...
    private static readonly SolidColorBrush Connected = new(System.Windows.Media.Color.FromRgb(3, 218, 198));
    private static readonly SolidColorBrush Error = new(System.Windows.Media.Color.FromRgb(207, 102, 121));
    private static readonly SolidColorBrush Waiting = new(System.Windows.Media.Color.FromRgb(136, 136, 136));
